...
cor_sig_c1 <- subset(cor_df, soft_adjp_c1 > -log10(0.01) & !(soft_adjp_c2 > -log10(0.01)),
                     select = c(1: 3, 13, 17))
cor_sig_c2 <- subset(cor_df, soft_adjp_c2 > -log10(0.01) & !(soft_adjp_c1 > -log10(0.01)),
                     select = c(4: 6, 14, 18))
cor_sig_both <- subset(cor_df, soft_adjp_c1 > -log10(0.01) & soft_adjp_c2 > -log10(0.01))
